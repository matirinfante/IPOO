...
function cargaDatos(&$unTeatro)
{
    ...
    while (!$salir) {
        ...
        switch ($tipo) {
            case "teatro":
                $tempFunc = new FuncionTeatral($nombreFuncion, $horaInicio, $duracion, $precioFuncion);
                break;
            case "cine":
                ...
                $tempFunc = new Cine($nombreFuncion, $horaInicio, $duracion, $precioFuncion, $genero, $pais);
                break;
            case "musical":
                ...
                $tempFunc = new Musical($nombreFuncion, $horaInicio, $duracion, $precioFuncion, $director, $espectadores);
                break;
        }
        if (!$unTeatro->insertarFuncion($tempFunc)) {
...
function modificarFunciones(Teatro &$unTeatro)
{
    ...
    $unTeatro->modificarFuncion($nombreFuncion, $nuevoNombre, $precioFuncion);
}
